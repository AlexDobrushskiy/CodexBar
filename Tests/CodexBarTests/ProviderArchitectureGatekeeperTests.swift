...
struct ProviderArchitectureGatekeeperTests {
    ...
    private static let allowedProviderConstructs: [AllowedProviderConstruct] = [
        ...
        AllowedProviderConstruct(
            ...
            expectedProviderIDs: ["claude", "codex"],
            expectedReferenceCount: 2,
            expectedReferenceFingerprint: ["codex@0", "claude@4"],
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/SpendDashboardController.swift",
            line: 311,
        ...
        AllowedProviderConstruct(
            path: "Sources/CodexBar/SpendDashboardController.swift",
            line: 735,
            anchor: "if providers.contains(.claude) {",
            expectedProviderIDs: ["claude", "codex"],
            expectedReferenceCount: 2,
            expectedReferenceFingerprint: ["claude@0", "codex@3"],
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/CodexBar/SpendDashboardController.swift",
            line: 766,
        ...
        AllowedProviderConstruct(
            ...
            expectedProviderIDs: ["claude", "codex"],
            expectedReferenceCount: 5,
            expectedReferenceFingerprint: ["claude@0", "codex@0", "codex@11", "codex@17", "codex@25"],
            reason: "This exact cost scanner dispatch selects a provider-owned transcript, cache, or pricing format."),
        AllowedProviderConstruct(
            path: "Sources/CodexBarCore/CostUsageFetcher.swift",
            line: 772,
        ...
        AllowedProviderConstruct(
            ...
            expectedProviderIDs: ["bedrock", "claude", "vertexai"],
            expectedReferenceCount: 3,
            expectedReferenceFingerprint: ["vertexai@0", "bedrock@2", "claude@4"],
            reason: "This exact cost scanner dispatch selects a provider-owned transcript, cache, or pricing format."),
        AllowedProviderConstruct(
            path: "Sources/CodexBarCore/CostUsageFetcher.swift",
            line: 1773,
