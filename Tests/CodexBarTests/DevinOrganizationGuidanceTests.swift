...
struct DevinOrganizationGuidanceTests {
        ...
        _ code: Int) async throws
    {
        try await DevinSessionImporter.withImportSessionOverrideForTesting { _, _, _ in
            ...
            let transport = ProviderHTTPTransportStub { request in
                ...
                let firstPath = request.url?.path == "/api/org/example-org/billing/quota/usage"
            ...
            do {
                ...
                if let path = ProcessInfo.processInfo.environment["CODEXBAR_DEVIN_PROOF_DIR"] {
    ...
    @Test(arguments: [401, 403], ["Token expired", "No organizations found for another user"])
