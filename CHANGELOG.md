...
### Fixed
- Abacus AI: show the monthly allowance when Credits is explicitly selected for the menu-bar percentage, with a Credits label and unchanged billing resets and pacing.
